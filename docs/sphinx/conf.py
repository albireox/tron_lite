...
try:
    from tron_lite import __version__
except ModuleNotFoundError:
    from sdsstools import get_package_version
    __version__ = get_package_version(__file__, 'sdss-tron-lite') or 'dev'
...
extensions = ['sphinx.ext.autodoc', 'sphinx.ext.napoleon', 'sphinx.ext.autosummary',
              ...
              'sphinx.ext.intersphinx', 'sphinx.ext.githubpages']
...
project = 'tron_lite'
copyright = '{0}, {1}'.format('2020', 'José Sánchez-Gallegogo')
author = 'José Sánchez-Gallegogo'
...
.. |tron_lite_version| replace:: {__version__}
"""
...
htmlhelp_basename = '{0}pdoc'.format('tron_lite')
...
man_pages = [
    (master_doc, 'tron_lite', u'{0} Documentation'.format(project),
     [author], 1)
]
...
if use_releases == 'yes':
    ...
    releases_github_path = 'sdss/tron_lite'
